...
VIDEO_CARDS="${RADEON_CARDS} d3d12 freedreno intel lavapipe lima nouveau panfrost v3d vc4 virgl vivante vmware imagination"
...
pkg_pretend() {
	if use vulkan; then
		if ! use video_cards_d3d12 &&
		   ...
		   ! use video_cards_v3d &&
		   ! use video_cards_imagination; then
...
multilib_src_configure() {
	...
	emesonargs+=(
		...
		$(meson_use video_cards_imagination imagination-srv)
